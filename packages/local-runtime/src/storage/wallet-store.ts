...
import type { WalletPreparation } from '../../../contracts/src/wallet.js';
export class WalletStore {
 private readonly db:DatabaseSync;
 constructor(path:string){mkdirSync(dirname(path),{recursive:true});this.db=new DatabaseSync(path);this.db.exec('PRAGMA journal_mode=WAL; PRAGMA synchronous=FULL; CREATE TABLE IF NOT EXISTS preparations (id TEXT PRIMARY KEY,body TEXT NOT NULL,checksum TEXT NOT NULL);');}
