...
async function setup(){
 ...
 const options={stateDir:join(dir,'state'),outputDir:join(dir,'output'),webDir:resolve('apps/local-web/web'),instructionDecoder:{model:'test',configured:false,decode:async()=>{throw Error('No model calls in profile tests');}}};
